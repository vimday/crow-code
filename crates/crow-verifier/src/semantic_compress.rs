//! Language-aware log compression heuristics.
//!
//! Provides utilities to reduce massive diagnostic logs (e.g. from `cargo test` or `tsc`)
//! into condensed, semantically relevant snippets to fit safely within LLM context windows
//! without discarding critical stack traces or error boundaries.
